...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">@lang('Users')</h5>
    </div>
            ...
            <table class="table table-bordered table-lg">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$list->name}}</td>
                        <td>
                            <form action="{{ route('dashboard.users.update',$list->id) }}" method="post">
                        ...
                        <td>
                            <ul class="icons-list">
                                <li>
                                    <a class="btn btn-default" href="{{ route('dashboard.users.edit',$list->id) }}"><i class="icon-pencil"></i></a>
                                </li>
                                <li>
                                    {!! delete_list_from_table('dashboard.users.destroy',$list->id) !!}
                                </li>
                            </ul>
                        </td>
                    </tr>
